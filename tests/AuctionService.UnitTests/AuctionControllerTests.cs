...
namespace AuctionService.UnitTests
{
    public class AuctionControllerTests
    {
        ...
        public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
        {
            ...
            _auctionRepo.Setup(repo => repo.GetAuctionByIdAsync(It.IsAny<Guid>())).ReturnsAsync(auctions);

            // act
            var result = await _controller.GetAuctionById(auctions.Id);
        ...
        [Fact]
        public async Task GetAuctionById_WithInvalidGuid_ReturnsNotFiybd()
        {
            // arrange
